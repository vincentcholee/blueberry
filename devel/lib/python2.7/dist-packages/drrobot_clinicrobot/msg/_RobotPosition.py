"""autogenerated by genpy from drrobot_clinicrobot/RobotPosition.msg. Do not edit."""
import sys
...
class RobotPosition(genpy.Message):
  _md5sum = "0ac379ad435e9dde0e291abbdaeea644"
  _type = "drrobot_clinicrobot/RobotPosition"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# robot position information message from DrRobot Robot.
...
"""
  __slots__ = ['header','robot_x','robot_y','robot_heading']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,robot_x,robot_y,robot_heading
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3f.pack(_x.robot_x, _x.robot_y, _x.robot_heading))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.robot_x, _x.robot_y, _x.robot_heading,) = _struct_3f.unpack(str[start:end])
      return self
