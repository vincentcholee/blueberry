"""autogenerated by genpy from drrobot_clinicrobot/RangeArray.msg. Do not edit."""
import sys
...
class RangeArray(genpy.Message):
  ...
  _type = "drrobot_clinicrobot/RangeArray"
...
"""
  __slots__ = ['ranges']
  _slot_types = ['drrobot_clinicrobot/Range[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = drrobot_clinicrobot.msg.Range()
        _v3 = val1.header
        start = end
        end += 4
