...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/drrobot2/hokuyo_exp/src/amcl)
  set(amcl_DEVEL_PREFIX /home/drrobot2/hokuyo_exp/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/drrobot2/hokuyo_exp/install)
...
if(NOT "/home/drrobot2/hokuyo_exp/devel/include;/home/drrobot2/hokuyo_exp/src/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/drrobot2/hokuyo_exp/devel/include;/home/drrobot2/hokuyo_exp/src/amcl/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drrobot2/hokuyo_exp/src/amcl/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
